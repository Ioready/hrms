                ...
                <div class="modal-body scroll-y">
                        ...
                        <form class="form-horizontal" name="addInvoices" id="addInvoices" method="post">
                                    ...
                                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                                        ...
                                        <div class="input-group">
                                        <input id="invoice_name" class="form-control" placeholder="Invoice" readonly name="invoice_name" type="text" value="<?php echo generateRandomCode(6);?>">
                                         </div>
                                    </div>
                                ...
                                <div class="form-group col-lg-4 col-sm-12 sm-5 ">
                                    ...
                                    <div class="input-group col-sm-5">
                                          <select name="invoice_status" id="invoice_status" required class="form-control">
                            ...
                            <div class="box-footer text-center">
                                ...
                                <a href= "<?php echo base_url('Invoices/');?>"><button type="button" class="btn btn-green btn-flat" >Discard</button></a>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
