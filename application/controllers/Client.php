...
class Client extends CI_Controller {
    ...
    public function index() {
        ...
        $data['getClient'] = $this->Client_model->getAllClient();
    ...
    public function editClient() {
        ...
        $getSingleClient['getClient'] = $this->Client_model->getSingleClient($cilentId);
    ...
    public function addClient_ctrl() {   
        $isexistsname = $this->Client_model->nameExistsCheck($_POST['fname']);
        if(!empty($isexistsname))
        {
            print_r(3);exit;
        }     
        $fields = array(
            'ca_fname' => isset($_POST['fname']) ? $_POST['fname'] : '',
            'ca_lname' => isset($_POST['lname']) ? $_POST['lname'] : '',
            'ca_emailid' => isset($_POST['emailid']) ? $_POST['emailid'] : '',
            'ca_phoneNumber' => isset($_POST['phoneNumber']) ? $_POST['phoneNumber'] : '',
            'ca_password'=> isset($_POST['password']) ? $_POST['password'] : '',
            'ca_confirm_password' => isset($_POST['confirm_password']) ? $_POST['confirm_password'] : '',
            'ca_website' => isset($_POST['website']) ? $_POST['website'] : '',            
            'ca_postalcode' => isset($_POST['postalcode']) ? $_POST['postalcode'] : '',
            'ca_country' => isset($_POST['country']) ? $_POST['country'] : '',
            'ca_state' => isset($_POST['state']) ? $_POST['state'] : '',
            'ca_city' => isset($_POST['city']) ? $_POST['city'] : '',
            'ca_address' => isset($_POST['address']) ? $_POST['address'] : '',
            'ca_notes' => isset($_POST['notes']) ? $_POST['notes'] : '',
            'ca_gstin' => isset($_POST['gstin']) ? $_POST['gstin'] : '',            
            'ca_createdDate' => date('Y-m-d H:i:s'),
            'ca_createdIpaddress' => $_SERVER['REMOTE_ADDR']            
        );

        $result = $this->Client_model->addClient_ctrl($fields);
        print_r(1);
        
    }

public function deleteclient() {
    $result = $this->Client_model->deleteclient();
    print_r($result);
}

public function updateclient() {
    $isexistsname = $this->Client_model->editNameExistsCheck($_POST['ca_fname'],$_POST['ca_id']);
    if(!empty($isexistsname))
    {
        print_r(3);exit;
    }     
    $fields = array(
        'ca_fname' => isset($_POST['ca_fname']) ? $_POST['ca_fname'] : '',
        'ca_lname' => isset($_POST['ca_lname']) ? $_POST['ca_lname'] : '',
        'ca_emailid' => isset($_POST['ca_email']) ? $_POST['ca_email'] : '',
        'ca_phoneNumber' => isset($_POST['ca_phoneNumber']) ? $_POST['ca_phoneNumber'] : '',
        'ca_password' => isset($_POST['ca_password']) ? $_POST['ca_password'] : '',
        'ca_confirm_password' => isset($_POST['ca_confirm_password']) ? $_POST['ca_confirm_password'] : '',
        'ca_website' => isset($_POST['ca_website']) ? $_POST['ca_website'] : '',
        'ca_postalcode' => isset($_POST['ca_postalcode']) ? $_POST['ca_postalcode'] : '',
        'ca_address' => isset($_POST['ca_address']) ? $_POST['ca_address'] : '',
        'ca_notes' => isset($_POST['ca_notes']) ? $_POST['ca_notes'] : '',
        'ca_gstin' => isset($_POST['ca_gstin']) ? $_POST['ca_gstin'] : '',
        'updated_ipaddress' => $_SERVER['REMOTE_ADDR']
    );

    $where = array('ca_id' => base64_decode($_POST['ca_id']));

    $result = $this->Client_model->updateClient($fields, $where);
