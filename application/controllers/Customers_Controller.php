...
class Customers_Controller extends CI_Controller
{
	...
	public function printToExcel()
	{
		...
		//////////// Copying blank file
		$fileName = "excelfiles/Customers_".date("Y_m_d_").date("H_i_s").".xlsx";
		...
		// $objPHPExcel->getActiveSheet()->setCellValue('A3', 'Customer: ' . $this->input->post('Customer'));
		...
		// $objPHPExcel->getActiveSheet()->setCellValue('D5', 'Mobile');
		// $objPHPExcel->getActiveSheet()->setCellValue('E5', 'Email');
		// $objPHPExcel->getActiveSheet()->setCellValue('F5', 'Remarks');
		
		$objPHPExcel->getActiveSheet()->setCellValue('A5', 'S.N.');
		$objPHPExcel->getActiveSheet()->setCellValue('B5', 'Name');
		$objPHPExcel->getActiveSheet()->setCellValue('C5', 'Mobile');
		$objPHPExcel->getActiveSheet()->setCellValue('D5', 'Email');
		...
		for($k=0; $k < $r-1; $k++)
		{
		    ...
		    // $myCol = $myCol + 1;
		 	...
		 	$objPHPExcel->getActiveSheet()->setCellValueExplicit('C'.$i,$myTableData[$k]['mobile1'],\PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
		    $myCol = $myCol + 1;
		 	$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($myCol, $i, $myTableData[$k]['email']);
		    $myCol = $myCol + 1;
