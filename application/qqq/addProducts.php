                ...
                <div class="modal-body scroll-y">
                        ...
                        <form class="form-horizontal" name="addProduct" id="addProduct" method="post">
                                    ...
                                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                                        ...
                                        <input id="p_name" class="form-control " placeholder="Name" name="p_name" type="text">
                                         </div>
                                    </div>
                                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                                        <label for="code" class="form-label mb-3">Product Code:<span class="redtxt">*</span></label>
                                        <div class="input-group">
                                        <input id="p_code" class="form-control " placeholder="Product Code" name="p_code" type="text">
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4 col-sm-12 mb-5 ">
                                        ...
                                        <div class="input-group">
                                        <input id="u_price" class="form-control " placeholder="Unit Price:" name="u_price" type="text">
                                         </div>
                                    </div>
                                    ...
                                    <label for="price" class="form-label mb-3">Description:</label>
                                        <div class="input-group">
                                        <textarea class="form-control " placeholder="Description" id="u_notes" name="u_notes" rows="4" cols="50"></textarea>
                                        </div>
                                    </div>
