                                ...
                                <table id="client_tbl" width="100%" cellpadding="0" cellspacing="0" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                      <?php if(isset($getAllProduct) && !empty($getAllProduct)){ 
                                        ...
                                        <td>
                                        <a data-toggle="modal" href= "<?php echo base_url('Products/editProducts/').base64_encode($value['id']); ?>"> <i class="fa fa-pencil" data-toggle="tooltip"  data-original-title="Edit Product"></i></a> |
                                            <a data-toggle="modal" data-target="#deleteProductModal" onclick="setdeleteproductId('<?php echo $value['id']; ?>');"><i class="fa fa-trash" data-toggle="tooltip" data-original-title="Delete Product" data-placement="left" title=""></i></a>
                                          </td>
                                        </tr>
                                      <?php }} ?>
