...
///////Yearly
    ...
    {
        $q = "Select sum(amt)-sum(recd) as balance, customers.customerRowId, customers.customerName,customers.mobile1, customers.address,customers.remarks,customers.email from customers LEFT JOIN ledger  ON ledger.customerRowId=customers.customerRowId AND ledger.deleted='N' WHERE customers.deleted='N' group by customers.customerRowId, customers.customerName,customers.mobile1, customers.address,customers.remarks order by customerName";
